...
class Utils {
  ...
  static void showToast({
    ...
    showOverlay(
      ...
      duration:
          duration ?? Duration(milliseconds: message.length < 40 ? 4000 : 7000),
  ...
  static Color getColor(int index) {
    List<Color> defaultColor = const [
      Color(0xFF257180), // Nâu đỏ
      Color(0xFFFFD23F), // Xanh lá cây nhạt
      Color(0xFF3A6D8C), // Xanh dương pastel
      Color(0xFFB8001F), // Tím oải hương
  ...
  static int getDaysInMonth(int year, int month) {
    ...
    DateTime nextMonth = (month == 12)
        ? DateTime(
            year + 1, 1, 1) // Nếu tháng là 12, chuyển sang tháng 1 của năm sau
